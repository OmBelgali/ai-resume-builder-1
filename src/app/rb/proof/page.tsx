      ...
      <section className="space-y-3 rounded-lg border border-slate-800 bg-slate-950/40 p-4">
        ...
        <div className="space-y-2 text-xs">
          <label className="block space-y-1">
            <span className="text-slate-300">Lovable project link</span>
            <input
              type="url"
              value={lovableLink}
              onChange={(e) => setLovableLink(e.target.value)}
              placeholder="https://app.lovable.dev/..."
              className="w-full rounded-md border border-slate-800 bg-slate-950/70 px-3 py-2 text-xs text-slate-100 outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500/60"
            />
          </label>
          <label className="block space-y-1">
            <span className="text-slate-300">GitHub repository link</span>
            <input
              type="url"
              value={githubLink}
          ...
          <label className="block space-y-1">
            <span className="text-slate-300">Production deploy link</span>
            <input
              type="url"
              value={deployLink}
